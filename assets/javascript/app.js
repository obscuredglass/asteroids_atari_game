...
const GAME_LIVES = 3;
// max distance laser can travel as fraction of screen width
...
const ROID_JAG = 0.4;
// points scored for a large asteroid
const ROID_PTS_LGE = 20;
// points scored for a medium asteroid
const ROID_PTS_MED = 50;
// points scored for a small asteroid
...
// duration in seconds of a single blink during ship's invisibility
const SHIP_BLINK_DUR = 0.1;
// duration of the ship's explosion in seconds
const SHIP_EXPLODE_DUR = 0.3;
// duration of the ship's invisibility in seconds
